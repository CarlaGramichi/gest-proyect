    ...
    <div class="col-md-4 stretch-card grid-margin">
        <div class="card bg-gradient-danger card-img-holder text-white">
            <div class="card-body">
                ...
                <h4 class="font-weight-normal mb-3">Proyectos<i class="mdi mdi-chart-line mdi-24px float-right"></i>
                </h4>
...
{{--                <h6 class="card-text">Finalizados el 80%</h6>--}}
    ...
    <div class="col-md-4 stretch-card grid-margin">
        <div class="card bg-gradient-info card-img-holder text-white">
            <div class="card-body">
                <img src="{{asset('images/dashboard/circle.svg')}}" class="card-img-absolute" alt="circle-image" />
                <h4 class="font-weight-normal mb-3">Proyectos<i class="mdi mdi-bookmark-outline mdi-24px float-right"></i>
                </h4>
    ...
    <div class="col-md-4 stretch-card grid-margin">
        <div class="card bg-gradient-success card-img-holder text-white">
            <div class="card-body">
                <img src="{{asset('images/dashboard/circle.svg')}}" class="card-img-absolute" alt="circle-image" />
                <h4 class="font-weight-normal mb-3">Proyectos<i class="mdi mdi-diamond mdi-24px float-right"></i>
                </h4>
...
<div class="row">
    <div class="col-lg-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Estadisticas de los últimos años</h4>
                ...
                <div class="list-wrapper">
                    <ul class="d-flex flex-column-reverse todo-list todo-list-custom">
                        <li>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="checkbox" type="checkbox"> Reunión con Ana </label>
                            </div>
                        ...
                        <li>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="checkbox" type="checkbox"> Presentación 15hs</label>
                            </div>
                            <i class="remove far fa-times-circle"></i>
                        </li>
